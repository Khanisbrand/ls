...
import sys
os.system('clear')
randomvalue = input('[+] Input Random Value Between (2000-5000): ')
import threading
import time
import sys
import requests
...
def gt(idd, tkn):
    ...
    dat = {
        ...
        'pretty': 'false',
        'format': 'json',
        'variables': '{"profile_id":' + idd + ',"suggestion_friends_paginating_first":' + randomvalue + '}',
...
def HANNAN_KING():
    ...
    if css == '1':
        ...
        data = '350685531728|62f8ce9f74b12f84c123cc23437a4a32'
    ...
    return 'access_token'
    if Exception:
        e = str(hashlib.md5(str(uuid.uuid4()).encode()).hexdigest()[:32])
